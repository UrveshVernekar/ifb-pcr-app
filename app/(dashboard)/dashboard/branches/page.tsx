  ...
  const columns: Column<Branch>[] = useMemo(() => {
    const cols: Column<Branch>[] = [
      ...
      },
      {
        ...
        render: (branch) => branch.region_name || <span className="text-zinc-400 italic">None</span>,
      },
      {
        header: 'City / State',
      ...
      },
      {
        ...
        render: (branch) => branch.contact_number || <span className="text-zinc-400 italic">None</span>,
      },
      {
        header: 'Status',
        render: (branch) => (
      ...
      <Card className="border border-zinc-200/80 dark:border-zinc-800/80 shadow-md bg-white/70 dark:bg-zinc-900/70 backdrop-blur-md rounded-2xl">
        ...
        <CardContent className="p-0">
          <BaseTable
            ...
            emptyDescription="Try modifying your search or add a new branch."
            keyExtractor={(branch) => branch.branch_id}
          />
        </CardContent>
      </Card>
